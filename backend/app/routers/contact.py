...
def submit_contact_form(payload: ContactRequest, request: Request, db: Session = Depends(get_db)):
    ...
    send_email(to_email=target_email, reply_to=payload.email, subject=subject_line, body=body_text)
